...
public class PriceNotAvailableExceptionTest {
    ...
    void givenMessage_whenCreatingException_thenMessageIsSetCorrectly() {
        PriceNotAvailableException exception = new PriceNotAvailableException(EXPECTED_MESSAGE);
    ...
    void givenNullMessage_whenCreatingException_thenMessageIsNull() {
        PriceNotAvailableException exception = new PriceNotAvailableException(NULL_MESSAGE);
